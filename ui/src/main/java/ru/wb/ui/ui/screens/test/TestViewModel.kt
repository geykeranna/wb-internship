...
class TestViewModel: ViewModel() {
    private val _chipsDataSingle = MutableStateFlow(listOf(ChipsData(id="1", name = "Test1")))
    private val chipsDataSingle: StateFlow<List<ChipsData>> = _chipsDataSingle
    ...
    val chipsList = listOf(
        ...
        ChipsData(id="4", name = "Test4444444"),
    ...
    fun onSelectChipsMultiple(list: List<ChipsData>) = viewModelScope.launch {
        _chipsDataMultiple.emit(list)
    }
}